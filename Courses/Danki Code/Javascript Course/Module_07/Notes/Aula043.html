<html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"/><title>Aula 043 - App Lista de Supermercado 2/3</title><style>
/* cspell:disable-file */
...
</style></head><body><article id="eb6ccf5b-977f-432d-9a9b-83efb238734f" class="page sans"><header><div class="page-header-icon undefined"><span class="icon">🟡</span></div><h1 class="page-title">Aula 043 - App Lista de Supermercado 2/3</h1></header><div class="page-body"><pre id="220bc187-bd73-4a96-a400-aec10d41ec8b" class="code"><code>&lt;!DOCTYPE html&gt;
&lt;html lang=&quot;pt-BR&quot;&gt;
  &lt;head&gt;
    &lt;meta charset=&quot;UTF-8&quot; /&gt;
  ...
  &lt;/body&gt;
&lt;/html&gt;</code></pre><pre id="fa8a62a0-c060-4043-85b7-6ec82c7dc253" class="code"><code>* {
  margin: 0;
  padding: 0;
  box-sizing: border-box;
}
...
.soma-produto {
  margin: 20px;
}</code></pre><pre id="ff62ac38-036a-484d-ace3-c7db66b26d57" class="code"><code>var items = [];
